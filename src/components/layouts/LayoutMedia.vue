...
const getisHoveredMedia = (data) => {
    isHoveredMedia.value = data
}
    ...
    <div class="h-full items-center z-50 absolute w-[27rem]">
        <div class="relative">
            ...
            <template v-if="isHoveredMedia === 0 || isHoveredMedia === 1">
                <div class="absolute type_writer_option left-[12rem] text-[#4C4840] font-medium top-[0.75rem] text-lg transform transition-transform duration-500 ease-in-out">
                    <span>- Photos</span>
                </div>
            </template>
        ...
        <div class="flex flex-row ml-12 mt-20 space-x-7">
                ...
                <div class="flex flex-col justify-center w-full h-full gap-[19px]">
                    <div class="order-1 button_over cursor-pointer">
                        <label for="Skill" class="hover:border-y-2 py-2 border-primary-buttonText">
                            <button @click="getisHoveredMedia(1)"
                                ...
                                <span class="ml-6 ">Photos</span>
                            </button>
                        </label>
                    </div>
                    <div class="order-1 button_over cursor-pointer">
                        <label for="Skill" class="hover:border-y-2 py-2 border-primary-buttonText">
                            <button @click="getisHoveredMedia(2)"
