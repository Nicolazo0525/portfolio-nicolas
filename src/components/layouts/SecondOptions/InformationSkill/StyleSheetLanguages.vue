...
<template>
    <template v-if="isHoveredOption === 23">
        <div class="w-full space-y-2">
            <div class="w-full h-full flex justify-center">
                <div class="w-20 h-28 rounded-md shadow-sm shadow-dark-600">
                    <img src="../../../../../public/CSS3_logo_and_wordmark.svg.png" class="w-20 h-28 object-fill rounded-md" alt="">
                </div>
            </div>
