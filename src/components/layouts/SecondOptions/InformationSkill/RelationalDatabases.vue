...
<template>
    <template v-if="isHoveredOption === 49">
        <div class="w-full space-y-2">
            <div class="w-full h-full flex justify-center">
                <div class="w-28 h-28 rounded-md shadow-sm shadow-dark-600">
                    <img src="../../../../../public/mariadb.png" class="w-28 h-28 object-fill rounded-md" alt="">
                </div>
            </div>
    ...
    <template v-if="isHoveredOption === 50">
        <div class="w-full space-y-2">
            <div class="w-full h-full flex justify-center">
    ...
    <template v-if="isHoveredOption === 51">
        <div class="w-full space-y-2">
            <div class="w-full h-full flex justify-center">
                <div class="w-36 h-28 rounded-md shadow-sm shadow-dark-600">
                    <img src="../../../../../public/MySQL.png" class="w-36 h-28 object-fill rounded-md" alt="">
                </div>
            </div>
            <hr class="bg-[#4C4840] border-[#4C4840]">
            <div class="grid grid-cols-3 justify-between gap-2 w-full text-sm">
    ...
    <template v-if="isHoveredOption === 53">
        <div class="w-full space-y-2">
            <div class="w-full h-full flex justify-center">
                <div class="w-28 h-28 rounded-md shadow-sm shadow-dark-600">
                    <img src="../../../../../public/PostgreSQL.png" class="w-28 h-28 object-fill rounded-md" alt="">
                </div>
            </div>
            <hr class="bg-[#4C4840] border-[#4C4840]">
            <div class="grid grid-cols-3 justify-between gap-2 w-full text-sm">
