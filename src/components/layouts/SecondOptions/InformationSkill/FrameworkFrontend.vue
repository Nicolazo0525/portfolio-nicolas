...
<template>
    ...
    <template v-if="isHoveredOption === 29">
        <div class="w-full space-y-2">
            <div class="w-full h-full flex justify-center">
                <div class="w-28 h-28 rounded-md shadow-sm shadow-dark-600">
                    <img src="../../../../../public/emberjs.png" class="w-28 h-28 object-fill rounded-md" alt="">
                </div>
            </div>
    ...
    <template v-if="isHoveredOption === 36">
        <div class="w-full space-y-2">
            <div class="w-full h-full flex justify-center">
                <div class="w-40 h-28 rounded-md shadow-sm shadow-dark-600">
                    <img src="../../../../../public/vuejs.png" class="w-40 h-28 object-fill rounded-md" alt="">
                </div>
            </div>
            <hr class="bg-[#4C4840] border-[#4C4840]">
            <div class="grid grid-cols-3 justify-between gap-2 w-full text-sm">
